// Sample symptom list — replace with the real list from your Flask backend
// or fetch dynamically from an endpoint like GET /symptoms
export const SYMPTOM_LIST: string[] = [
  ...
  "movement_stiffness", "spinning_movements", "loss_of_balance", "unsteadiness", "loss_of_smell",
  "bladder_discomfort", "passage_of_gases", "internal_itching", "toxic_look_(typhos)", "depression",
...
export const formatSymptom = (s: string) =>
